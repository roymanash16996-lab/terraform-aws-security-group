...
# Creation Logic: Created only if `vpc_name` is not provided (empty string), indicating use of the default VPC.
# Variable Dependency: Depends on `var.vpc_name`. If empty, count = 1 and default = true; otherwise, count = 0.
